...
{
  std::cout << "GEMDigiToRawModule constructor name=" << name_ << ", useDBEMap=" << useDBEMap_ << std::endl;
...
{
  std::cout << "GEMDigiToRawModule::globalBeginRun name=" << name_ << ", useDBEMap=" << useDBEMap_ << std::endl;
